---
title: jquery.json.js 处理json转成dom
date: 2021-04-09
categories:
 - 学习
tags:
...
```js
  var str = '[{ "a": 134 }]';
  var result = new JSONFormat(str, 4).toString();
  console.log(result)
...
参考：[源代码](https://gitee.com/srcker/json-help/tree/master)